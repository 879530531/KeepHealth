...
<body>
    ...
    <div class="formtitle"><span>导师基本信息</span></div>
   <%--会员编号和联系方式不用改，但要输出值，value的值除了密码也要输出 --%> 
    ...
    <li><label>导师编号：</label><input name="tbPersonalData.personalNumber" type="text"  class="dfinput" value="${tbPersonalData.personalNumber}" readonly="readonly"/></li>
    ...
    <li><label>会员昵称：</label><input name="tbPersonalData.name" type="text"  class="dfinput" value="${tbPersonalData.name}"/><i><font color="#FF0000">*必填</font>不能超过20个汉字</i></li>
    <li><label>真实姓名：</label><input name="tbPersonalData.realName" type="text" class="dfinput" value="${tbPersonalData.realName}" /><i><font color="#FF0000">*必填</font>不能超过20个汉字</i></li>
    <li ><label>性别：</label>
        <div class="radio">
    ...
    <li><label>电子邮箱：</label><input name="tbPersonalData.email" type="text" class="dfinput" value="${tbPersonalData.email}"></input><i><font color="#FF0000">*必填</font></i></li>
    <li><label>出生日期：</label><input name="tbPersonalData.birthday" type="text" class="dfinput" value="${tbPersonalData.birthday}" onClick="WdatePicker({lang:'zh-cn',maxDate:new Date()});"></input></li>
    <li><label>身份证号码：</label><input name="tbPersonalData.idCard" type="text" class="dfinput" value="${tbPersonalData.idCard}"></input><i><font color="#FF0000">*必填</font></i></li>
    <li><label>婚姻状况：</label>
        <div class="radio">
    ...
    <li><label>导师级别：</label>
        <div class="radio">
        <input type="radio" name="tbPersonalData.level" value="0" <c:if test="${tbPersonalData.level==0}">checked="checked"</c:if>/>导师&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="radio" name="tbPersonalData.level" value="1" <c:if test="${tbPersonalData.level==1}">checked="checked"</c:if>/>普通导师&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="radio" name="tbPersonalData.level" value="2" <c:if test="${tbPersonalData.level==2}">checked="checked"</c:if>/>高级导师
        </div>
    </li>    <li><label>指导方向：</label><input name="tbPersonalData.direction" type="text"  class="dfinput" value="${tbPersonalData.direction}"/></li>
    <li><label>导师简介：</label><textarea name="introduction" style="overflow:visible;" onkeydown="checkMaxInput(this,1000)"  
            onkeyup="checkMaxInput(this,1000)" onfocus="checkMaxInput(this,1000)" onblur="checkMaxInput(this,1000);resetMaxmsg()"onpropertychange="if(value.length>1000) value=value.substr(0,1000)">${tbPersonalData.introduction}</textarea></li>
    <li><label>头像：</label>
