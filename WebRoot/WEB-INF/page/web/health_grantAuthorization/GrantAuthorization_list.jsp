...
<div class="formbody">
                ...
                <s:iterator value="pageResult.data">
                    <tr>
                        ...
                        <c:choose>
                         ...
                         <td width="18%">
                            <a href="<%= basePath%>/biz/TbGrantAuthorization_openEdit.action?personalId=${personalId}" class="tablelink">授权课程</a>&nbsp;&nbsp;
                        </td>
                    </tr>
                </s:iterator>
    ...
    <script type="text/javascript">
        var url = "<%= basePath%>/biz/TbGrantAuthorization_list.action?flagType=0"; //获取表单url
        //首页
        function first(){
