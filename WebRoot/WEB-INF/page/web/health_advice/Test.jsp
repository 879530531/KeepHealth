...
<body>
    ...
    <div class="formtitle"><span>11</span></div>
    <form action="<%= basePath%>/biz/TbAdvice_add.action" method="post" id="commonform">
    <ul class="forminfo">
    <li><label>调理建议</label><input name="adviceContent" id="adviceContent" type="text" class="dfinput" /><i><font color="#FF0000">*必填</font>不能超过20个汉字</i></li>
