						...
						<li>
							<div class="item1-link item1-content" style="margin:1px">
								<div class="item1-media">
									...
									<div style="padding-right:40px;"><font >${requestScope.username}</font></div>
									<div style="padding-left:40px;"><font>${requestScope.time}</font></div>
									</div>
								</div>
			...
			<div class="div_main_main1">
				<div class="tabs">
					<div id="tab1" class="tab active">
						...
						<font color="black" >主要症状:</font>
						</div>
						<div class="div_main_bottom">
							<form action="<%=basePath%>/biz/TbConsultationRecord_teacherAdvise.action?TbConsultationRecord.recordId=${requestScope.recordid}" name="form"
									id="a" method="post">
								...
								<table width="100%" height="160" border="0">
									<tr>
										...
										<c:when test="">
										 ...
										 <c:otherwise>
											<textarea class="B8" name="advice" id="advice"  placeholder="请输入回复内容："></textarea>
   										</c:otherwise>
										</c:choose>
