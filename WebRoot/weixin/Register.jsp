...
<body>
	<form action="<%= basePath%>/front1/TbPersonalData_add.action"
							...
							<li>
								<div class="item-content">
									...
									<div class="item-innerp">
										...
										<div class="item-input">
											<input type="text" name="birthday" id='picker'
												readonly='readonly' value="2017-07-22 11:36" />
										</div>
									</div>
								</div>
							</li>
									...
									<div class="item-innerp">
										...
										<div class="item-input">
											<input type="text" name="mobilePhone" id="mobilePhone"
												placeholder="Mobile phone"> <span id="gradeInfo"></span>
										</div>
									</div>
								</div>
							</li>
						...
						<div class="row">
							...
							<div class="col-50">
								<a class="button button-big button-fill button-success"
									href='javascript:' onclick='$("#tijiao").click()'>注册</a>
							</div>
							<div class="col-50">
								<a href="/front1/TbPersonalData_returnMemberLogin.action"
