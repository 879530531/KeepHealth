					...
					<ul>
						<li>
							<div class="item1-link item1-content">
								<div class="item1-media"><img src="/upload/${tbPersonalData.image}"
								...
								<div class="item1-inner">
									<div class="item1-title-row">
										<div class="item1-title">
											<span style="font-size:0.85rem;">导师昵称：&nbsp;${tbPersonalData.realName}&nbsp;<img
												src="/images/mentor.png"
												style='width: 1.1rem;height:0.9rem;vertical-align:middle;'></span>
										</div>
					...
					<ul>
						...
						<li class="item-content">
							<div class="item-innerd">
								...
								<div class="item-input">${tbPersonalData.personalNumber}</div>
							</div>
						</li>
						<li class="item-content">
							<div class="item-innerd">
