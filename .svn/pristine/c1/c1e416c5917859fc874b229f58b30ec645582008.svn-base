...
<body>
	<form
		action="<%= basePath%>/biz/TbTeacher_changePassword.action"
							...
							<li>
								<div class="item-content">
									...
									<div class="item-inner">
										...
										<div class="item-input">
											<input type="password" name="teacherPasswork" id="teacherPasswork"
	...
	<script type="text/javascript">
		function validate() {
			var a = document.getElementById("teacherPasswork").value;
