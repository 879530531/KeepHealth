...
<script type="text/javascript">
	...
	$(".sure").click(function(){
		$(".tip").fadeOut(100);
		window.location.href="<%= basePath%>/biz/SysUnit_delete.action?unitId="+id;
	});
...
<div class="formbody">
    <div id="usual1" class="usual">
      <div id="tab2" class="tabson">
     	...
     	<form action="<%= basePath%>/biz/SysUnit_list.action" method="post"  target="rightFrame">
    	<ul class="seachform">
    		    <li><label>公司编码：</label><input class="scinput" name="sysUnit.unitCod"   placeholder="请输入公司编码"/></li>
    		    <li><label>公司名称：</label><input class="scinput" name="sysUnit.unitName"   placeholder="请输入公司名称"/></li>
    	    <li><label>公司类型</label><input class="scinput" name="sysUnit.unitType"   placeholder="请输入公司类型"/></li>
            <li><input name="" type="submit" class="scbtn" value="查询"/></li>
            <p:permissions right="addCompany" >
            	<li class="clickk"><span><img src="<%=path%>/images/t01.png" /></span><a href="<%= basePath%>/biz/SysUnit_openAdd.action">添加</a></li>
            </p:permissions>
    ...
    <table class="tablelist">
        ...
        <th>业务类型</th>
       <p:permissions menu="deleteCompany,editCompany">
        <th>操作</th>
        </p:permissions>
        </tr>
        </thead>
        ...
        <p:permissions menu="deleteCompany,editCompany">
        <td width="100px">&nbsp;
        	<p:permissions right="deleteCompany" >
        		<a href="javascript:;" class="tablelinkdelete" idValue="${unitId}">删除</a>&nbsp;&nbsp;
        	</p:permissions>
        	<p:permissions right="editCompany" >
        		<a href="<%= basePath%>/biz/SysUnit_openEdit.action?unitId=${unitId}" class="tablelink">修改</a>
        	</p:permissions>
        </td>
        </p:permissions>
        </tr> 
...
<%
//查询的url地址，统一写
String listActionURL = basePath+"/biz/SysUnit_list.action";
%>
