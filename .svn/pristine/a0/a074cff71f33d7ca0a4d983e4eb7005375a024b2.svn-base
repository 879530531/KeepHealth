							...
							<div class="item1-link item1-content" style="margin:1px">
								...
								<div class="item1-inner">
									...
									<div class="" style="padding-top: 2.0rem" >
									 <span
											style="margin:8rem auto;font-size:22px;font-weight:500">${tbTeacher.teacherName }老师</span>&nbsp;&nbsp;
			...
			<div class="div_main_main1">
				<div class="tabs">
					<div id="tab1" class="tab active">
						...
						<div class="div_main_main2" align="left" style="margin:35px 0px 0px 17px">主要症状</div>
						<div class="div_main_bottom">
							<form action="<%=basePath %>biz/TbConsultationRecord_saveConsultationRecord.action"
								...
								<table width="100%" height="160" border="0">
									<tr>
										...
										<c:when test="">
										 ...
										 <c:otherwise>
											<textarea class="B8" name="ConsultationText" id="ConsultationText"  placeholder="请输入咨询内容："></textarea>
   										</c:otherwise>
										</c:choose>
											<input type="hidden" value="${tbTeacher.teacherId }" name="tbTeacher.teacherId"  id="">
