 ...
 * 
* @ClassName: ReferData 
* @Description: 未处理咨询管理  咨询详情 实体类   封装多表查询得到的结果
* @author 软件开发中心  陈洁 
* @date 2017年7月8日 上午3:05:25
 */
public class ReferData {
	...
	* @throws
	 */
	public ReferData(String qq,String name,String realName,Integer sex,String placeDomicile,String mobilePhone,String image,String email,Object birthday, String idCard,Integer maritalStatus,String professional,String address,
			String readmeContent,Object readmeTime,String mentorName) throws java.text.ParseException{
		   super();
		   this.qq=qq;
		   this.name=name;
		   ...
		   this.birthday = stringToTimestamp2(birthday.toString());
